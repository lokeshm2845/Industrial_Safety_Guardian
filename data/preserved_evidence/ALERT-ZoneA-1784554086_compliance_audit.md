...
## 📄 Incident Overview
- **Incident Reference ID:** `ALERT-ZoneA-1784554086`
- **Generation Timestamp:** `2026-07-20 18:58:06 UTC`
...
1. **Calibrate Area Sensors:** Cross-reference telemetry spool `ALERT-ZoneA-1784554086_sensor_evidence.json` to verify sensor response times.
