...
## 📄 Incident Overview
- **Incident Reference ID:** `ALERT-ZoneA-1784553902`
- **Generation Timestamp:** `2026-07-20 18:55:02 UTC`
...
1. **Calibrate Area Sensors:** Cross-reference telemetry spool `ALERT-ZoneA-1784553902_sensor_evidence.json` to verify sensor response times.
