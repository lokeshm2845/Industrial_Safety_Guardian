...
## 📄 Incident Overview
- **Incident Reference ID:** `ALERT-ZoneA-1784553932`
- **Generation Timestamp:** `2026-07-20 18:55:32 UTC`
...
1. **Calibrate Area Sensors:** Cross-reference telemetry spool `ALERT-ZoneA-1784553932_sensor_evidence.json` to verify sensor response times.
