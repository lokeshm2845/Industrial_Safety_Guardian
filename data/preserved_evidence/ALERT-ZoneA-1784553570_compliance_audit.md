...
## 📄 Incident Overview
- **Incident Reference ID:** `ALERT-ZoneA-1784553570`
- **Generation Timestamp:** `2026-07-20 18:49:30 UTC`
...
- WARNING: Gas pre-alarm threshold reached (CO: 28.0 ppm, LEL: 11.2%)
- ALERT: Rapidly rising gas trend: CO rising at 14.35%/min, LEL rising at 14.89%/min
...
1. **Calibrate Area Sensors:** Cross-reference telemetry spool `ALERT-ZoneA-1784553570_sensor_evidence.json` to verify sensor response times.
