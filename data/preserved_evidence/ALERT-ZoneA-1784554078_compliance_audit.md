...
## 📄 Incident Overview
- **Incident Reference ID:** `ALERT-ZoneA-1784554078`
- **Generation Timestamp:** `2026-07-20 18:57:58 UTC`
...
1. **Calibrate Area Sensors:** Cross-reference telemetry spool `ALERT-ZoneA-1784554078_sensor_evidence.json` to verify sensor response times.
